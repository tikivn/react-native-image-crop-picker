...
import ImagePicker from "@tikivn/react-native-image-crop-picker";
...
export default class App extends Component {
  ...
  cropImageToRect() {
    ...
    const height = this.state.image.width / 2;
    const width = this.state.image.height / 2;
    ImagePicker.cropImageToRect({
      path: this.state.image.uri,
      cropperRect: {
        x: 200,
        y: 0,
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          onPress={this.cropImageToRect.bind(this)}
          style={styles.button}
        >
          <Text style={styles.text}>Crop image to rect</Text>
        </TouchableOpacity>
      </View>
    );
  }
